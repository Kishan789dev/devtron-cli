...
func GetPoliciesList(paramsDetails *ArtifactPromotionPolicy.PoliciesList) ([]ArtifactPromotionPolicy.PayloadPolicyForCreate, error) {
	...
	return promotionPolicyClient.GetListOfPolicies(paramsDetails)
