...
func init() {
	...
	UpdatePromotionPolicyCmd.PersistentFlags().Int("approverCount", 0, " approver_count")
	UpdatePromotionPolicyCmd.PersistentFlags().Bool("allowImageBuilderFromApprove", false, "allow_image_builder_from_approve")
	UpdatePromotionPolicyCmd.PersistentFlags().Bool("allowRequestFromApprove", false, "allow_request_from_approve")
	UpdatePromotionPolicyCmd.PersistentFlags().Bool("allowApproverFromDeploy", false, "allow_approver_from_deploy")
